...
namespace WindowsFormsTest
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            count.Visible = false;
            label2.Text = "Генератор";
            selectDistibution.Items.Clear();
            selectDistibution.Items.Add("Random");
            selectDistibution.Items.Add("LCG");
            selectDistibution.Items.Add("XorShift");
            selectDistibution.Items.Add("PCG");
            selectDistibution.Items.Add("MersenneTwister");
            selectDistibution.Items.Add("xxHash");
        }
        ...
        private void buttonStart_Click(object sender, EventArgs e)
        {
            ...
            switch (selectDistibution.SelectedIndex)
            {
                ...
                case 1:
                    var rndClassic1 = new LCG(0);
                    for (int i = 0; i < 100; i++)
                    {
                        var rnd = new LCG(i);
                        int value = 0;
                        value = (int)rnd.Next(100);
                        chart2.Series[0].Points.AddXY(i, value);
                        chart2.Series[1].Points.AddXY(i, value);
                        var valueClassic = rndClassic1.Next(100);
                        chart1.Series[0].Points.AddXY(i, valueClassic);
                        chart1.Series[1].Points.AddXY(i, valueClassic);
                    }
                    break;
                ...
                case 2:
                    var rndClassic2 = new Xorshift(0);
                    for (int i = 0; i < 100; i++)
                    {
                        var rnd = new Xorshift(i);
                        int value = 0;
                        value = (int)rnd.Next(0, 100);
                        chart2.Series[0].Points.AddXY(i, value);
                        chart2.Series[1].Points.AddXY(i, value);
                        var valueClassic = rndClassic2.Next(0, 100);
                        chart1.Series[0].Points.AddXY(i, valueClassic);
                        chart1.Series[1].Points.AddXY(i, valueClassic);
                    }
                    break;
                ...
                case 3:
                    var rndClassic3 = new PCG(0);
                    for (int i = 0; i < 100; i++)
                    {
                        var rnd = new PCG((ulong)i);
                        var value = rnd.Next(0, 100);
                        chart2.Series[0].Points.AddXY(i, value);
                        chart2.Series[1].Points.AddXY(i, value);
                        var valueClassic = rndClassic3.Next(0, 100);
                        chart1.Series[0].Points.AddXY(i, valueClassic);
                        chart1.Series[1].Points.AddXY(i, valueClassic);
                    }
                    break;
                ...
                case 4: 
                    var rndClassic4 = new MersenneTwister(0);
                    for (int i = 0; i < 100; i++)
                    {
                        ...
                        chart2.Series[0].Points.AddXY(i, value);
                        chart2.Series[1].Points.AddXY(i, value);
                        var valueClassic = rndClassic4.Next(0, 100);
                        chart1.Series[0].Points.AddXY(i, valueClassic);
                        chart1.Series[1].Points.AddXY(i, valueClassic);
                    }
                    break;
                ...
                case 5:
                    var rndClassic5 = new BaseSensor(0);
                    for (int i = 0; i < 100; i++)
                    {
                        var rnd = new BaseSensor((uint)i, 0, 100);
                        int value = 0;
                        value = (int)rnd.Next();
                        chart2.Series[0].Points.AddXY(i, value);
                        chart2.Series[1].Points.AddXY(i, value);
                        var valueClassic = rndClassic5.Next(0, 100);
                        chart1.Series[0].Points.AddXY(i, valueClassic);
                        chart1.Series[1].Points.AddXY(i, valueClassic);
                    }
                    break;
